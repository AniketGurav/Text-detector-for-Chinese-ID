...
in which format data is required???
"""
...
'''
    below function only calls train model and does not define any network
'''
    ...
    for i in (xrange(1,epoch+1)):
        ...
        for j in tqdm(xrange(steps)):
            if backend == 'tf':
                ...
                '''
                    will it work tensorflow is backend 
                '''
            ...
            for k in range(size):
                ...
                try:
                    ...
                    '''
                        does data support pascal voc format??
                    '''
                    ...
                    '''
                        what is target is it segmented image???
                    '''
            ...
            '''
                why below is commented I think neeed to uncomment for training??
            '''
...
if __name__ == '__main__':
    ...
    model = create_multi_res_model() # load architecture 
    model.compile('adam',cross_entropy) 

    train_mode = 'sequence'
    '''
        what is difference between sequence and non sequence mode???
    '''
